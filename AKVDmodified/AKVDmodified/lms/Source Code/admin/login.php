                ...
                <form method="post" action="loginauthenticate.php">
                    ...
                    <div class="login-form-body">
                        <div class="form-gp">
                            ...
                            <input type="text" class="form-control" name="empid" maxlength=6 title="pattern required:combination of numbers and uppercase alphabets ranging from 2 to 6 letters  "  required pattern="^[A-Z 0-9]{2,6}$" required>
                            <i class="ti-email"></i>
