		        	...
		        	<form class="needs-validation" novalidate action="bookauthenticate.php" method="post">
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Author ID" name="Author_id" required>
                                <div class="valid-feedback">
                                    <?php echo $AUTHID_ERR; ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Author Name" name="Author_name" required>
                                <div class="valid-feedback">
                                    <?php echo $AUTHNAME_ERR; ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="pub_date" placeholder="PUB_DATE" name="PUB_DATE" required>
                                <div class="valid-feedback">
