...
// Execute the query
$sql = "SELECT DISTINCT user.username, user.RollId, user.id, user.Status, tblclasses.ClassName, tblclasses.Section 
        FROM tblresult 
        JOIN user ON user.id = tblresult.StudentId  
...
?>
    <tr>
        ...
        <td>
            <a href="edit-result-teacher.php?stid=<?php echo htmlentities($row['id']); ?>">
