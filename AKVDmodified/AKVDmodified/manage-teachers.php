...
$sql = "SELECT teacher.username,teacher.image,teacher.EmpId,teacher.id,teacher.email,teacher.password from teacher";
...
if(count($results) > 0) {
    ...
    foreach($results as $result) {
        ...
        <tr>
            ...
            <td>
                <a href="edit-teacher.php?id=<?php echo htmlentities($result['id']);?>">
